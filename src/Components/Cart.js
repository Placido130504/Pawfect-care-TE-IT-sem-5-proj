...
//                                 <div className='cart-name'>{cart.ProductName}</div>
//                                 <div className='cart-price-original'>Rs {cart.ProductPrice}.00</div>
//                                 <div className='inc' onClick={() => dispatch({ type: 'INC', id: cart.ProductID })}>
//                                     <Icon icon={ic_add} size={24} />
//                                 </div>
//                                 <div className='quantity'>{cart.qty}</div>
//                                 <div className='dec' onClick={() => dispatch({ type: 'DEC', id: cart.ProductID })}>
//                                     <Icon icon={ic_remove} size={24} />
//                                 </div>
//                                 <div className='cart-price'>Rs {cart.TotalProductPrice}.00</div>
//                                 <button className='delete-btn' onClick={() => dispatch({ type: 'DELETE', id: cart.ProductID })}>
//                                     <Icon icon={iosTrashOutline} size={24} />
//                                 </button>
//                             </div>
//                         ))}
